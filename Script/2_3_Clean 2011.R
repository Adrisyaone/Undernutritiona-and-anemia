...
IRdata2011_sub<-IRdata2011 |> 
  select(caseid,v190,v218,v012,v130,v013,v131, v157, v481, v701,v106,v743a, v743b, v743d , d106, d107, d108)
...
PRdata<-PRdata |> 
  ...
  left_join(IRdata2011_sub, by=c("mother_id"="caseid"))
